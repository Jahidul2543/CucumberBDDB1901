    ...
    public  void initializeTest() {
        ...
        if(browserName.equalsIgnoreCase("chrome")){
            ...
            if (getOsNameFromSystem.contains("Mac")) {
                System.setProperty("webdriver.chrome.driver", "../automationpractice/driver/chromedriver");
            } else if (getOsNameFromSystem.contains("Windows")) {
                System.setProperty("webdriver.chrome.driver", "automationpractice/driver/chromedriver.exe");
            }
